...
#define USI_START_VECTOR USI_START_vect   // Interrupt vector: USI start condition
#define USI_OVERFLOW_VECTOR USI_OVF_vect  // Interrupt vector: USI 4-bit counter overflow
#endif
...
#define TWI_START_COND_INT USISIE         // Control register bit: defines whether an I2C START condition triggers an interrupt
#define USI_OVERFLOW_INT USIOIE           // Control register bit: defines whether a USI 4-bit counter overflow triggers an interrupt
#define USI_START_VECTOR USI_STR_vect     // Interrupt vector: USI start condition
#define USI_OVERFLOW_VECTOR USI_OVF_vect  // Interrupt vector: USI 4-bit counter overflow
#endif
